...
@Component("highestRatedItemsStrategy")
@RequiredArgsConstructor
public class HighestRatedItemsSuggestionStrategy implements ItemSuggestionStrategy {

    private final ItemRepository itemRepository;

    @Override
    public List<Item> getSuggestedItems() {
        return itemRepository.findByStatusOrderBySellerAverageRatingDesc(ItemStatus.AVAILABLE);
    }
}
